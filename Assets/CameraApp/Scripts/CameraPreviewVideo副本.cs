...
public class CameraPreviewVideo : MonoBehaviour {
	...
	//mj
	public GameObject _ShowCameraObject;
...
//	private int _restartCount = 0;
	...
	void OnGUI() {
		if ((webCamTexture != null) && webCamTexture.isPlaying) {
		    ...
		    //UnityEngine.GUI.DrawTexture(_drawRect, webCamTexture);//mj
	...
	void Update()
	{
		MeshRenderer renderer = _ShowCameraObject.GetComponent<MeshRenderer> ();
